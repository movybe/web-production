    ...
    function (_React$Component) {
        ...
        function Campaign() {
            ...
            _defineProperty(_assertThisInitialized(_this), "handleCampaignTypeChange", function (e) {
                ...
                var action = _this.getSelectedCampaignType().toLowerCase().indexOf("merchant") >= 0 ? _this.props.resetState({ ..._this.props,
            ...
            _defineProperty(_assertThisInitialized(_this), "handleCampaignFormSubmit", function (e) {
                ...
                if (!_this.props.emailVerified) {
                    ...
                    $.post(defaults.actions, {
                        ...
                        var action = response.error ? _this.props.resetState({ ..._this.props,
                            user: response.user,
                            email: email,
                            accountType: defaults.merchantAccountType,
                            alreadyExistingAccount: true
                    ...
                    $.post(defaults.actions, {
                        ...
                        defaults.payWithPaystack(email, defaults.convertToPaystack(amount), accountName, function (response) {
                            ...
                            $.post(defaults.actions, {
                                ...
                                var action = !response.success ? _this.props.resetState({ ..._this.props,
                                    emailVerified: true,
                                    stateReset: false
                                }) : _this.loginModalPopup.modal('close') && _this.props.resetState({ ..._this.props,
                                    emailVerified: true,
                                    stateReset: false,
                                    email: email,
                                    user: response.user,
        ...
        _createClass(Campaign, [{
            ...
            value: function componentDidMount() {
                ...
                var stateToReset = this.stateRestored ? { ...this.props,
                    stateReset: true,
                    emailVerified: false,
                    showRefererEmailField: false
                } : { ...storageObj,
