...
var MerchantPlugs = function (_React$Component) {
  ...
  function MerchantPlugs() {
    ...
    _defineProperty(_assertThisInitialized(_this), "defaultActions", function () {
      ...
      try {
        _this.filePath = $('input.file-path');
    ...
    _defineProperty(_assertThisInitialized(_this), "adForm", function () {
      var adTypeAndAdUnitsStyle = _this.state.showNewAdFields ? {
        'display': 'block'
      } : {
        'display': 'none'
      };
    ...
    _defineProperty(_assertThisInitialized(_this), "modifyAdForm", function (e) {
      ...
      var adID = null,
          clickedAd = {},
          showNewAdFormFields = action == (_this.editAdFormActions.NEW || _this.editAdFormActions.RENEW);
      ...
      switch (action) {
        ...
        case _this.editAdFormActions.RENEW:
          ...
          _this.setState(_objectSpread({}, _this.state, {
            showNewAdFields: showNewAdFormFields,
  ...
  _createClass(MerchantPlugs, [{
    ...
    value: function render() {
      ...
      var newAdsModalTrigger = numberOfAdSpace.map(function (index) {
        currentAd = _this2.props.ads[index] || false;
        ...
        playAdSpan = isEmptyAd ? null : React.createElement("span", {
          ...
          "data-ad-id": currentAd.ad_id,
          "data-pause": false,
          onClick: _this2.changeAdActiveStatus
        }, "play_arrow "));
        ...
        if (!isEmptyAd) {
          editAdFormAction = Number(currentAd.active) ? _this2.editAdFormActions.UPDATE : _this2.editAdFormActions.RENEW;
          ...
          editAdFormAction = _this2.editAdFormActions.NEW;
        }
