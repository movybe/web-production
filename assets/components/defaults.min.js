...
var Defaults = function () {
  ...
  function Defaults() {
    ...
    this.isProductionMode = window.location.hostname.indexOf('.com') >= 0;
    this.hostName = window.location.hostname;
    this.siteName = 'Movybe';
    this.termsAndConditionsVersion = 1.0;
    ...
    this.ajaxProgress = function (e) {
      ...
      if (percent < 2) $('.progress.progress-bar').show();
      if (percent === 100) $('.progress.progress-bar').hide();
...
Pace.on('done', function (e) {
  if (!pageLoaded) {
    var paceCss = $('link[title="pace-css"]');
    pageLoaded = true;
