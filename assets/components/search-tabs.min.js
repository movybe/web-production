...
var LocalSearchTab = function (_React$Component) {
  ...
  function LocalSearchTab() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleFacebookShareButtonClick", function (e) {
      _this.props.switchWebsite(_objectSpread({}, _this.props, {
        sharedFacebookPage: true
      }));
    });
  ...
  _createClass(LocalSearchTab, [{
    ...
    value: function componentDidUpdate() {
      ...
      this.defaultActions();
      var currentPrice, max, priceString, pricesArrayLength, allPricesArray, totalPrice, x, sum, price, priceList, adsLength, isOddAdLength, average, priceListLengthDividedBy4, priceListLengthDividedBy2, median, middleSum, sortAdInAscendingOrder, medianPlusMax;
      ...
      locale.forEach(function (local) {
        ...
        local.ads.forEach(function (ad) {
          ...
          if (currentPrice.indexOf('-') < 0 && currentPrice.indexOf(' ') < 0) {
            ...
            totalPrice = 0;
            allPricesArray.forEach(function (price) {
        ...
        local.max = numeral(max).format('0.0a');
    ...
    value: function render() {
      ...
      var tabList = locale.map(function (local, index) {
        ...
        return React.createElement("li", {
          ...
          alt: defaults.capitalize(local.shortName),
          title: defaults.capitalize(local.shortName),
          "data-src": defaults.imageDirectory + local.shortName + '.png',
          className: "responsive-img tab-icons lazyload"
        })));
      });
      var loadMoreButton;
      var facebookShareFooter = null;
      facebookShareFooter = this.props.sharedFacebookPage ? null : React.createElement("footer", {
        className: "white darken-2 ",
        id: "site-footer"
        ...
        id: "share-on-faceboox-text"
      }, "Share on Facebook"), React.createElement("h6", {
        className: "right"
      }, React.createElement("a", {
        className: "btn btn-block blue facebook-share-button text-lighten-3 right",
        onClick: this.handleFacebookShareButtonClick,
        target: "_blank",
        href: "https://www.facebook.com/sharer/sharer.php?u=" + window.location.hostname
      }, "Share")))));
      var tabContainers = locale.map(function (local, pos) {
        ...
        var template = local.ads.length ? local.ads.map(function (ad, index) {
          ...
          lastUpdatedTimestamp = local.lastUpdatedTimestamp ? React.createElement("h6", null, React.createElement("span", {
            className: "red-text"
          }, "Updated : "), " ", React.createElement("span", {
            className: "stored-timestamp",
            "data-datetime": local.lastUpdatedTimestamp || '2019-11-05 00:42:08'
          })) : null;
          showAdImage = !_this3.props.settings.showImages && !ad.showAdImage ? React.createElement("a", {
            ...
            onClick: function onClick(e) {
              ...
              _this3.toggleImageView(e, local, pos, ad, index);
            }
          }, "View") : null;
          showAdImage = showAdImage === null && !_this3.props.settings.showImages && ad.showAdImage ? React.createElement("a", {
            ...
            onClick: function onClick(e) {
              ...
              _this3.toggleImageView(e, local, pos, ad, index, false);
            }
          }, "Hide") : showAdImage;
          ...
          return React.createElement("div", {
            ...
            title: ad.long_description || null
        ...
        }, local.name, " ", averagePrice), lastUpdatedTimestamp, preloader, React.createElement("div", {
          id: local.shortName + searchResults
        }, template, loadMoreButton, facebookShareFooter));
      });
      return React.createElement("div", {
