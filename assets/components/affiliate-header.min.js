...
var AffiliateHeader = function (_React$Component) {
  ...
  function AffiliateHeader() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleWithdrawalForm", function (e) {
      ...
      if (_this.withdrawalForm.valid()) {
        ...
        var paymentAmount = totalWithdrawalAmount - hundredPerThousand;
        var profit = hundredPerThousand - defaults.withdrawalCharge;
