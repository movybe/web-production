...
var MerchantHeader = function (_React$Component) {
  ...
  function MerchantHeader() {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateUserLastReadTermsAndConditions", function (e) {
      e.preventDefault();
      var data = {
        email: _this.props.user.email,
        version: defaults.termsAndConditionsVersion,
        action: 'UPDATE_USER_LAST_READ_TERMS_AND_CONDITIONS'
      };
      ...
      $.post(defaults.actions, {
        ...
        if (response.success) {
          ...
          _this.props.modifyState(_objectSpread({}, _this.props, {
            user: user
          }));
        }
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "navContents", function () {
      var showUpdatedTermsAndConditionsBadge = defaults.termsAndConditionsVersion > _this.props.user.terms_and_conditions_version ? React.createElement("span", {
      ...
      return React.createElement("div", null, React.createElement("li", {
        ...
        className: "material-icons small left"
      }, "assignment"), "Terms of service ", showUpdatedTermsAndConditionsBadge)), React.createElement("li", null, React.createElement("a", {
        onClick: _this.handleNavClick,
    ...
    _defineProperty(_assertThisInitialized(_this), "webNavs", function () {
      ...
      }, "Welcome, ", _this.props.user.user_id), React.createElement("ul", {
    ...
    _defineProperty(_assertThisInitialized(_this), "tosModal", function () {
      return React.createElement("div", {
        ...
        href: "#",
        onClick: function onClick(e) {
          _this.updateUserLastReadTermsAndConditions(e);
