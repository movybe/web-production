  ...
  function Campaign() {
    ...
    _defineProperty(_assertThisInitialized(_this), "defaultPage", function () {
      return React.createElement("div", {
        ...
        className: "card-content"
      }, React.createElement("h3", null, "Get your ad on ", defaults.siteName, " today"), ".", React.createElement("p", null, "Be seen by customers at the very moment that they\u2019re searching on ", defaults.siteName, " for the things you offer. And only pay when they click to visit your website, products page or call."), React.createElement("h4", null, "Why ", defaults.siteName, " Ads?"), React.createElement("p", {
        className: "strong"
      }, "Attract more customers."), React.createElement("p", null, "Whether you\u2019re looking to bring in new website visitors, grow online sales, get the phones ringing or keep customers coming back for more,", defaults.siteName, " Ads can help."), React.createElement("h4", null, "Reach the right people at the right time"), React.createElement("p", null, "Your business gets found by people on ", defaults.siteName, " precisely when they\u2019re searching for the things that you offer."), React.createElement("h4", null, "You only pay for results."), React.createElement("p", {
        className: "strong"
      }, "No visit, no fee."), React.createElement("p", null, "Signing up for ", defaults.siteName, " Ads is free. You only pay when someone clicks your ad to visit your website, or calls you. In other words, when your advertising is working."), React.createElement("h4", null, "Start with your own budget."), React.createElement("p", null, "You set your own budget, so your costs will depend on what you are trying to accomplish with your advertising. Some businesses spend tens of thousands of dollars a month, and others are comfortable investing several hundred."), React.createElement("h4", null, "Take the guesswork out of advertising."), React.createElement("p", {
        className: "strong"
      }, "See how your ads are doing."), React.createElement("p", null, "With ", defaults.siteName, " Ads you will see how many people are shown your ads, visit your website, or call your business. You can even target specific types of people if your business is specialized.")))), React.createElement("div", {
      ...
      }, "Continue ")))))), React.createElement(Footer, {
