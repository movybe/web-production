...
class  LocalSearchTab extends React.Component{
    ...
    componentDidUpdate() {
        ...
        let max , priceString , pricesArrayLength  , allPricesArray , totalPrice , x ,sum, price , priceList , adsLength , isOddAdLength , average , priceListLengthDividedBy4 , priceListLengthDividedBy2, median , middleSum ,sortAdInAscendingOrder , medianPlusMax;
        ...
        locale.forEach(local => {
            ...
            local.ads.forEach((ad) => {
                ...
                if(ad.price.indexOf('-') < 0 && ad.price.indexOf(' ') < 0) {
                    ...
                    pricesArrayLength = 0;
                    allPricesArray = ad.price.split(' ') || ad.price.split('-');
                    totalPrice = 0;

                    allPricesArray.forEach(price => {

                        priceString = price.toString().replace(/\D/g, '');
...
{ad.description}
            ...
            return (
                ...
                <div id={local.shortName} className="col s12 gallery" key={local.name}>
                    ...
                    <p className='flow-text' style={{color : local.textColor,  'text-transform' : 'capitalize'}}>{local.name} {averagePrice}</p>
                    {preloader}
