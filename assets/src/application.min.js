            ...
            case defaults.websites.olist :
                ...
                this.tryGetCachedResult(this.getRandomCrawler() , this.getRequestObject(url) , url ,  response => {
                    ...
                    if(resp.update){
                        ...
                        let data = {url , ads , email : 'username@domain.com' , action : this.updateSearchResultAction , query , website : defaults.websites.olist , page : pageNumber};
            ...
            case defaults.websites.jiji :
                ...
                this.tryGetCachedResult(this.getRandomCrawler() , this.getRequestObject(url) , url ,  response => {
                    ...
                    if(resp.update){
                        ...
                        let data = {url , ads, email : 'username@domain.com' , action : this.updateSearchResultAction , query , website : defaults.websites.jiji , page : pageNumber};
                        data = JSON.stringify(data);
                        $.post(defaults.actions ,  {data} , response=> {});
                    }
