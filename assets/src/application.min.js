class Application extends React.Component {
    ...
    getRandomCrawler = () => {
        ...
        let crawlers = [
            ...
            "https://tradevest.uk/crawler.php",
            "https://snoott.com/crawler.php",

            "https://africauniteonline.com/crawler.php",
            defaults.crawler
        ...
        let crawler = crawlers[randomCrawlerIndex];
        console.log(crawler);
    ...
    */
    ...
    switchToWebsite = (
        ...
        */
        ...
        let queryArray, titleArray, queryArrayLength, localQuery, localTitle, numberOfQueryWordsInTitle,
            ratioOfRelationship,
            titleSyllablesArray, querySyllablesArray, resolveAdState, updateTimestamp = false, storedTimestamp = null,
            storedTimestampObject, wordSyllable, numberOfQuerySyllablesInTitleSyllables, querySyllablesArrayLength,
            lastQuery = null, runQueryActions;
        ...
        */
        ...
        if (!isfirstSearch && !this.props.switchWebsite({
            ...this.props,
        ...
        */
        ...
        const promise = (data) => {
            ...
            return Promise.resolve(
                $.post(defaults.actions, {data}, json_response => {
                ...
                this.tryGetCachedResult(this.getRandomCrawler() , this.getRequestObject(url) , url ,  response => {
                    ...
                    if(resp.update) {
                        ...
                        data = {
                            ...
                            action: this.updateSearchResultAction,
                            query,
                    ...
                    resolveAdState = async () => {

                        storedTimestampObject = updateTimestamp ? JSON.parse(await promise(data)): resp;
            ...
            case defaults.websites.jiji :
                ...
                this.tryGetCachedResult(this.getRandomCrawler() , this.getRequestObject(url) , url ,  response => {
                    ...
                    if(resp.update){
                        ...
                        updateTimestamp = true;
                        data = {url , ads, email : 'username@domain.com' , action : this.updateSearchResultAction , query , website : defaults.websites.jiji , page : pageNumber};
                        data = JSON.stringify(data);
                    }
            ...
            case defaults.websites.jumia :
                ...
                this.tryGetCachedResult(this.getRandomCrawler() , this.getRequestObject(url) , url, response => {
                    ...
                    if(resp.update){
                        ...
                        updateTimestamp = true;
                        data = {url , ads : selectedEcommerce.ads, email : 'username@domain.com' , action : this.updateSearchResultAction , query , website : defaults.websites.jumia , page : pageNumber};
                        data = JSON.stringify(data);
            ...
            case defaults.websites.konga :
                ...
                this.tryGetCachedResult(this.getRandomCrawler() , this.getRequestObject(url) , url ,  response => {
                    ...
                    if(resp.update){
                        ...
                        updateTimestamp = true;
                        data = {url : req , ads : selectedEcommerce.ads, email : 'username@domain.com' , action : this.updateSearchResultAction, query , website : defaults.websites.konga, page : pageNumber};
                        data = JSON.stringify(data);
                        $.post(defaults.actions ,  {data} , response=> {});
                    }
            ...
            case defaults.websites.deals :
                ...
                this.tryGetCachedResult(this.getRandomCrawler() , this.getRequestObject(url) , url , response => {
                    ...
                    if(resp.update){
                        ...
                        updateTimestamp = true;
                        data = {url , ads : selectedEcommerce.ads, email : 'username@domain.com' , action : this.updateSearchResultAction, query , website : defaults.websites.deals, page : pageNumber};
                        data = JSON.stringify(data);
    ...
    getRandomDefaultWebsite = () => {
        ...
        return [randomClassifiedAdWebsite /*, randomClassifiedAdWebsite, randomEcommerceWebsite */];
    };
