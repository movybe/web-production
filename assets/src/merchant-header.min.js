...
class  MerchantHeader extends React.Component {
    ...
    updateUserLastReadTermsAndConditions = (e) => {
        e.preventDefault();
        let data  = {email : this.props.user.email , version : defaults.termsAndConditionsVersion , action : 'UPDATE_USER_LAST_READ_TERMS_AND_CONDITIONS'};
        data = JSON.stringify(data);

        $.post(defaults.actions , {data} ,
                response => {
            ...
            if(response.success) {
                ...
                user.last_read_terms_and_conditions = response.timestamp;
                user.terms_and_conditions_version = defaults.termsAndConditionsVersion;

                this.props.modifyState({...this.props , user});
    ...
    navContents = () => {
        ...
        //console.log(defaults.termsAndConditionsVersion, ",", this.props.user.terms_and_conditions_version)
        let showUpdatedTermsAndConditionsBadge = defaults.termsAndConditionsVersion > this.props.user.terms_and_conditions_version ?
            <span className="new badge play-badge" data-badge-caption = "updated"></span> :
            null;
        return (
            <div>
                ...
                <li className="header-nav"><a className="modal-trigger" onClick={this.handleNavClick} href="#tos-modal"><i className="material-icons small left">assignment</i>Terms of service {showUpdatedTermsAndConditionsBadge}</a></li>
            ...
            <div className="site-header">
                ...
                <nav>
                    <div className="nav-wrapper">
                        ...
                        <a href="#demo-mod" className="brand-logo  right watch-demo-video modal-trigger">Welcome, {this.props.user.user_id}</a>
    ...
    tosModal = () =>
       {
        ...
        return(
            ...
            <div id="tos-modal" className="modal modal-fixed-footer">
                ...
                <div className="modal-footer">
                    <a href="#" onClick={(e) => {this.updateUserLastReadTermsAndConditions(e); this.tosModalPopUp.modal('close')}} className="modal-close waves-effect waves-green btn-flat no-underline strong light">OK, I've accepted</a>
                </div>
            </div>
