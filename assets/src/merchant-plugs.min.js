...
*/
    ...
    adModal = () =>
    {
        ...
        const proceedButton =Number(this.props.user.subscribed) ?
            <label htmlFor="submit-ad-form-button" tabIndex="0" className="waves-effect waves-light btn" id="ad-form-proceed">Proceed</label> : null;
    ...
    adForm = () => {
        let adTypeAndAdUnitsStyle = this.state.showNewAdFields ?
                                ...
                                <div className="row">
                                    ...
                                    <div className="input-field col s12">
                                        ...
                                        <input data-name = "title" placeholder="Please write a clear title for your ad" id="ad-title"
                                               ...
                                               data-length = {this.adFormRules.maxAdTitleLength}
                                ...
                                <div className="row">
                                    <div className="input-field col s12">
                                        ...
                                        <textarea placeholder="Enter a detailed description" id="ad-description"
                                                  ...
                                                  data-length = {this.adFormRules.maxAdDescriptionLength}
                                        ></textarea>
...
<input type = "submit" id = "submit-ad-form-button" className='hidden  hide' value = 'Submit'/>
    ...
    modifyAdForm = e => {
        ...
        let adID = null , clickedAd = {} , showNewAdFormFields = (action == (this.editAdFormActions.NEW || this.editAdFormActions.RENEW));
        ...
        switch (action) {
            ...
            case this.editAdFormActions.RENEW:
                ...
                this.setState({...this.state ,showNewAdFields : showNewAdFormFields , editAdFormAction : action , editAdFormID : adID , editAd : clickedAd , adFormTriggerClicked : true} , this.updateEditAdFormFromState);
                break;
        }
        ...
        if(!adID) {
            ...
            this.setState({...this.state ,  showNewAdFields : showNewAdFormFields , editAdFormAction : action , editAd : {...this.initState.editAd} ,  editAdFormID : adID , uploadImage : false , adFormTriggerClicked : true} , this.loadDefaultTextsIntoFields);
