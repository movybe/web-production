    ...
    defaultPage = () => {
            ...
            <nav className="white" role="navigation">
                <div className="nav-wrapper container">
                    <a id="logo-container" href="#" className="campaign-page-head-links no-underline">
                        <img src={defaults.imageDirectory + defaults.siteName.toLowerCase() + '.png'} width='100' />
        ...
        <div className="row left">
            <h5 className="header col s12 light">
                <p>Get in front of customers when they’re searching for businesses and products like yours on {defaults.siteName}.</p>
                <p>You only pay for results, like clicks and views to your website or calls to your business or product line.</p>
            </h5>
            <p className='materialize-red-text center'>Preview</p>
        </div>
