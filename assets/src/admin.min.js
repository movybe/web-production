        ...
        let display = this.state.payment_details.length ?
            ...
            <table className="striped centered responsive-table highlight">
                ...
                <tr>
                    ...
                    <td>{this.state.payment_details[0].account_number} <a href='#' className='no-underline' onClick={() => {defaults.showCopiedToast(this.state.payment_details[0].account_number)}}>copy</a></td>
