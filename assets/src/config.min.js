    ...
    initState = {
        ...
        locale : [
           // {shortName : defaults.websites.jiji , name : defaults.websites.jiji        ,         textColor : 'green' , ads : [] ,  page : 0 , error : "" , loadMore : false , average : 0 , max : 0 , lastSortedPage : 0 , shownSponsoredAds : false} ,
            {shortName : defaults.websites.olist , name : defaults.websites.olist        ,         textColor : 'blue' , ads : [] ,  page : 0 , error : "" , loadMore : false , average : 0 , max : 0 , lastSortedPage : 0 , shownSponsoredAds : false, lastUpdatedTimestamp:null} ,
            {shortName : defaults.websites.konga , name : defaults.websites.konga       ,              textColor :  'orange' , ads : [] ,  page : 0 , error : "" , loadMore : false , average : 0 , max : 0 , lastSortedPage : 0, shownSponsoredAds : false, lastUpdatedTimestamp:null} ,
            {shortName : defaults.websites.jumia , name : defaults.websites.jumia       ,                 textColor : 'black' , ads : [] , page : 0 , error : "" , loadMore : false , average : 0 , max : 0 , lastSortedPage : 0 , shownSponsoredAds : false, lastUpdatedTimestamp:null} ,
            {shortName :  defaults.websites.deals ,name : defaults.websites.jumiaDeals ,          textColor : 'indigo' , ads : [] , page : 0 , error : "" , loadMore : false , average : 0 , max : 0 , lastSortedPage : 0, shownSponsoredAds : false, lastUpdatedTimestamp:null}
            ] ,
        international : [
        ...
        sponsoredAdsClicked : [] ,
        lastUpdated : /*dd-mm-yyyy HH:MM*/ "06-11-2019 01:57:AM",
        updateOnlyAds : true,
        sponsoredAds : [],
    };
